...
\location{Sep 2021 - now | SWE 2 | Prague, Czechia}
\vspace{\topsep} % Hacky fix for awkward extra vertical space

\begin{tightitemize}
\item Driving K8s migration.
\end{tightitemize}
\location{Dec 2020 - Sep 2021 | SWE 1 | Prague, Czechia}
\begin{tightitemize}
...
%------------------------------------------------
\runsubsection{CTM - Center for Talented Minds}
\descript{| Instructor}

\location{Sep 2020 - May 2021 | Prague, Czechia}
\begin{tightitemize}
...
\runsubsection{DL archs. for analyzing neural data}
\descript{| MSc. thesis}
...
%------------------------------------------------
\runsubsection{Devblog}
\descript{| Notes from ML papers etc.}
\emptyLocation % Hack to make following text correct size
\begin{tightitemize}
...
\runsubsection{miniRTS}
\descript{| minimalistic massive RTS}
\emptyLocation % Hack to make following text correct size
\begin{tightitemize}
